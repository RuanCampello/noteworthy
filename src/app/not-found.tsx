...
export default function NotFound() {
  ...
  return (
    <div className='h-screen w-screen flex flex-col gap-8 items-center justify-center text-neutral-200 bg-black'>
      <div className={`flex items-center text-9xl ${gothicOne.className}`}>
        <span>4</span>
        <div className='bg-neutral-200 rounded-full flex items-center p-4'>
          <Image
            src={Logo}
            width={85}
            height={85}
            alt='Logo'
            className='brightness-0 saturate-100 invert-[10%] sepia-[18%] saturate-[25%] hue-rotate-[314deg] brightness-[97%] contrast-100'
          />
        </div>
        <span>4</span>
      </div>
