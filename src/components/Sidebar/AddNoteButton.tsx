  ...
  return (
    ...
    >
      <AddNoteDialog>
        <button
          type='button'
          className='w-full shrink-0 group-data-[state=closed]/root:h-10 group-data-[state=closed]/root:w-10 bg-midnight hover:bg-white/10 transition-all duration-200 py-2 rounded-sm flex justify-center items-center gap-2 font-semibold group/button focus:outline focus:outline-white focus:outline-offset-2 focus:outline-2'
        >
          <Plus
            size={20}
